...
report = st.sidebar.selectbox("Epsilon Greedy Model",["Epsilon Greedy v0", "Epsilon Greedy v0.1", "Epsilon Greedy v0.2", "Epsilon Greedy v0.3"])
...
if report == "Epsilon Greedy v0.3":
	...
	if st.button('Compute'):
		...
		st.write("Simulating 2000 patients using arriv real quick.")
		...
		for i in range(2000):
			...
			#st.write(dftmp)
			df = df.append(dftmp)
		fig = px.scatter(df, x="Number patients simulated", y="Average Conversion Rate", range_x=[0,2000], range_y=[0,1])
